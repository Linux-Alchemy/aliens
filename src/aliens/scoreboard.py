...
class Scoreboard():
    ...
    def prep_high_score(self) -> None:
        ...
        # High score position on the screen
    ...
    def prep_level(self) -> None:
        ...
        level_indicator = (f"Level: {level_str}")
        self.level_image = self.font.render(level_indicator, True, self.text_color, self.settings.bg_color)
    ...
    def prep_ships(self) -> None:
        """Show remaining hero ships on the upper left of the screen"""
        self.ships = Group()
